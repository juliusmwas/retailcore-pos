      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            {activeBranch
              ? `Managing team for ${activeBranch.name}`
              : "Overseeing all business personnel"}
          </p>
        </div>
        <button
      ...
      {!loading && filteredStaff.length === 0 && (
        <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200">
          ...
          <p className="text-gray-500 text-lg">
            No staff found for this criteria.
          </p>
        </div>
      )}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div>
                  ...
                  <select
                    className="w-full p-3 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-blue-500 text-sm font-bold"
                    value={formData.role}
                    onChange={(e) =>
                ...
                <div>
                  ...
                  <select
                    required
                    className="w-full p-3 bg-gray-50 rounded-xl border-none focus:ring-2 focus:ring-blue-500 text-sm font-bold text-blue-600"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-bold py-4 rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 mt-4"
              >
            ...
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-blue-50/50">
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium">
                  Updating info for #{editingStaff?.staffNumber}
                </p>
              </div>
              <button
    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition-all group relative overflow-hidden">
      ...
      <div className="mt-6 space-y-3 border-t border-gray-50 pt-4 text-sm">
        ...
        <div className="flex items-center gap-3 text-gray-600">
          ...
          <span
            className={`font-medium ${member.role === "ADMIN" ? "text-purple-600" : "text-blue-600"}`}
          >
            {member.role === "ADMIN" &&
            (member.branchName === "Unassigned" || !member.branchName)
